...
export type WandMode = "recolor" | "select_similar";
...
export const STORY_STICKERS: Record<string, StickerDefinition[]> = {
  characters: [
    { id: "crown", name: "Crown", fill: "#f59e0b", svg: "M 10 70 L 20 25 L 45 45 L 50 15 L 55 45 L 80 25 L 90 70 Z" },
    { id: "teddy", name: "Teddy", fill: "#b45309", svg: "M 20 30 A 15 15 0 1 1 35 15 M 80 30 A 15 15 0 1 1 65 15 M 50 25 A 35 35 0 1 1 49.9 25 Z" },
    { id: "cat_paws", name: "Paw", fill: "#c2410c", svg: "M 50 50 C 40 50 30 65 50 85 C 70 65 60 50 50 50 Z M 25 40 A 8 12 0 1 1 25 39 M 42 28 A 8 12 0 1 1 42 27 M 58 28 A 8 12 0 1 1 58 27 M 75 40 A 8 12 0 1 1 75 39" },
    { id: "magic_wand", name: "Wand", fill: "#ec4899", svg: "M 50 10 L 56 26 L 72 26 L 60 36 L 64 52 L 50 42 L 36 52 L 40 36 L 28 26 L 44 26 Z M 50 45 L 85 90" },
  ],
  nature: [
    { id: "pine_tree", name: "Tree", fill: "#15803d", svg: "M 50 10 L 75 40 L 65 40 L 85 65 L 55 65 L 55 85 L 45 85 L 45 65 L 15 65 L 35 40 L 25 40 Z" },
    { id: "mushroom", name: "Shroom", fill: "#e11d48", svg: "M 15 50 C 15 15 85 15 85 50 Z M 40 50 L 40 85 L 60 85 L 60 50 Z" },
    { id: "sun", name: "Sun", fill: "#eab308", svg: "M 50 25 A 25 25 0 1 1 49.9 25 M 50 5 L 50 15 M 50 85 L 50 95 M 5 50 L 15 50 M 85 50 L 95 50 M 18 18 L 26 26 M 74 74 L 82 82 M 18 82 L 26 74 M 74 26 L 82 18" },
    { id: "flower_tulip", name: "Bloom", fill: "#db2777", svg: "M 50 30 C 20 30 20 70 50 80 C 80 70 80 30 50 30 M 50 80 L 50 95" },
  ],
  cozy: [
    { id: "teacup", name: "Tea", fill: "#a16207", svg: "M 20 35 L 25 80 C 25 88 75 88 75 80 L 80 35 Z M 77 45 C 90 45 90 70 76 70" },
    { id: "cupcake", name: "Cupcake", fill: "#fb7185", svg: "M 30 50 L 35 85 L 65 85 L 70 50 Z M 20 50 C 20 20 80 20 80 50 Z" },
    { id: "balloon", name: "Balloon", fill: "#ef4444", svg: "M 50 15 A 30 35 0 1 1 49.9 15 M 46 85 L 54 85 L 50 78 Z M 50 85 Q 55 95 45 105" },
    { id: "sailboat", name: "Boat", fill: "#0284c7", svg: "M 10 65 L 90 65 L 75 85 L 25 85 Z M 48 20 L 48 60 L 15 60 Z M 52 10 L 52 60 L 82 60 Z" },
  ],
};

const PALETTE_COLLECTIONS = [
  { name: "Cozy Café", colors: ["#2c211a", "#4d3a2e", "#8b6d5c", "#c68b59", "#dda15e", "#faf5ec"] },
  { name: "Mossy Forest", colors: ["#1c291e", "#3a5a40", "#588157", "#819b7a", "#a3b18a", "#dad7cd"] },
  { name: "Sweet Macaron", colors: ["#e07a5f", "#f4a261", "#e76f51", "#f7cad0", "#ffb3c6", "#ffffff"] },
  { name: "Midnight Sky", colors: ["#0f172a", "#1e293b", "#3d5a80", "#847596", "#9d4edd", "#f3f5fa"] },
];
  ...
  return (
    <aside className="lofi-dual-toolbox">
      <div className="toolbox-icon-rail">
        ...
        >
          <svg viewBox="0 0 24 24" className="rail-svg"><path d="M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27-7.38 5.74zM12 16l7.36-5.73L21 9.07l-9-7-9 7 1.63 1.27L12 16z" fill="currentColor" /></svg>
        </button>
        ...
        <div className="toolbox-flyout-drawer">
          <div className="drawer-header">
            <span className="drawer-title">
              ...
              {activeTool === "wand" && "Magic Wand Tool"}
            ...
            {activeTool === "wand" && (
              <div className="drawer-section">
                ...
                <div className="swatch-inline-row">
                  {PALETTE_COLLECTIONS[0].colors.concat(PALETTE_COLLECTIONS[2].colors.slice(0, 4)).map((c) => (
                    <button
                      key={`wand-${c}`}
                      className={`palette-swatch-circle ${wandColor === c ? "active" : ""}`}
                      style={{ backgroundColor: c }}
                      onClick={() => onSetWandColor(c)}
                    />
                  ))}
                  <input
                    type="color"
                    ...
                    value={wandColor}
                    onChange={(e) => onSetWandColor(e.target.value)}
                  />
                </div>
            ...
            {(activeTool === "arrange" || activeTool === "select") && (
              <div className="drawer-section">
                ...
                <div className="arrange-action-grid">
                  <button className="action-pill-btn" disabled={!hasSelection} onClick={onBringForward}>
                    Bring Forward
                  </button>
                  <button className="action-pill-btn" disabled={!hasSelection} onClick={onSendBackward}>
                    Send Backward
                  </button>
                  <button className="action-pill-btn" disabled={!hasSelection} onClick={onDuplicate}>
                    Duplicate Item
                  </button>
                  <button className="action-pill-btn danger" disabled={!hasSelection} onClick={onDelete}>
                    Delete (Del)
                  </button>
                </div>
              </div>
